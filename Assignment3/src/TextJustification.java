 ...
 *  ------
 *
 *  5) After counting the number of characters on a single line from the unjust.txt file opened in MS Word I found that 
 *     each line holds space for 78 characters. Following this I used the value of 78 as my entered page width and the maximum
 *     number of words of 15. Additionally, the string length I used was the same mentioned as in the specification which is 11.
 *     
 *     Following this I compared the results I received visually side by side and can confirm from this that MS  Word does indeed
...
public class TextJustification {
	...
	public static void main(String[] args) throws IOException {
		...
		Random random = new Random();
		for (int i = 0; i < n; i++) {
			lengthOfWord = random.nextInt(15) + 1;
			W[i] = RandomString(lengthOfWord); 
		}
